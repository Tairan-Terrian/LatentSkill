"""
Operation Bank: stores executable memory operations for LatentSkill decoding.
"""
import numpy as np
...
class OperationBank:
    """Operation Bank stores memory operations and their embeddings."""
    ...
    def get_candidate_operations(self) -> List[Operation]:
        ...
        # PPO also stores op embeddings per step, so dynamic banks remain self-consistent.
