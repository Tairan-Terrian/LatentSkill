...
class BaseTrainer:
    ...
    def __init__(self, args, config):
        ...
        self.controller = PPOController(
            ...
            latent_log_std_init=getattr(config, 'latent_log_std_init', -0.5)
        )
    ...
    def _process_session(self, session_text: str, memory_bank: MemoryBank,
        ...
        with torch.no_grad():
            action_idx, log_prob, value, latent_z = self.controller(
                state_tensor, op_tensor, deterministic=False
            )
        ...
        for epoch in range(self.ppo_epochs):
            ...
            for start in range(0, n_samples, minibatch_size):
                ...
                mb_batch = {
                    ...
                    'latents': [batch['latents'][i] for i in mb_indices],
    ...
    def train(self, train_data: List[Dict]):
        ...
        wandb_init_kwargs = {
            ...
            'config': {
                ...
                'latent_dim': getattr(self.controller, 'latent_dim', None),
